    ...
    return(
        <nav className="dui-nav-sch-act">
                <a className="dui-nav-sch-act__logo dui-util-txt-decoration-none" href="/pages/homePage/homePage.html">
                    <h3 className="dui-util-fw-bld dui-primary-color">
                        Garden Kart
                    </h3>
                </a>
                ...
                <ul className="dui-nav-sch-act__actions dui-ul">
                    <li>
                        <div className="dui-nav-sch-act__auth-actions">
                            {/* <!-- SignUp Button --> */}
                            <a className="dui-nav-sch-act__signup-btn dui-link dui-link--primary dui-util-txt-sm dui-util-spc-pad-0_8rem-xs dui-util-fw-bld"
                                href="/pages/authpage/signup.html">
                                Sign Up
                            </a>

                            {/* <!-- Login Button --> */}
                            <a className="dui-nav-sch-act__login-btn dui-link dui-link--primary dui-util-txt-sm dui-util-spc-pad-0_8rem-xs dui-util-fw-bld"
                    ...
                    <li>
                        <a className="dui-nav-sch-act__wish-lst-btn dui-util-disp-inline-block"
                    ...
                    <li>
                        <a className="dui-nav-sch-act__cart_lst-btn dui-link" href="/pages/cartPage/cartPage.html">
                            <div className="dui-util-clr-prim-p2">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    className="btn__icon icon icon-tabler icon-tabler-shopping-cart" width="56" height="56"
